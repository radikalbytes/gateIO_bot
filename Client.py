...
TOKEN = '517137125:AAFFZUVLppSWQAjvYJ7ULSjM8H93vLvz1yY' # Ponemos nuestro Token generado con el @BotFather
bot = telebot.TeleBot(TOKEN) # Combinamos la declaración del Token con la función de la API
lastTime = time()
# 填写 APIKEY APISECRET
apikey = 'B917F579-BA74-4275-8626-1FAB644A5C95'
secretkey = '92550d0a93baf38188db81bf9ecfb2a741b6916fca87ce407d1bc170f7124aec'
...
try:
    ...
    print("Diccionario: " + str(knownUsers))
except:
            ...
            if usuario['user_id'] == cid:
                ...
                for monedas in usuario['coin']:
                    ...
                    if precio ['result']=='true':
                        enviaPrecio += name + ": " + str(precio['last']) + "E " + str(precio['percentChange'])[:6]+"%\n"
